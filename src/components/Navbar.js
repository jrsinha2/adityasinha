    ...
    <header className="dark:bg-skin-base bg-skin-inverted md:sticky top-0 z-10">
      <div className="flex flex-row justify-between items-center">
        ...
        <div className="flex flex-row item-center justify-between">
          ...
          <button id="theme-toggle" type="button" className="text-skin-inverted dark:text-skin-base hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none  dark:focus:ring-gray-700 rounded-full text-sm p-2.5 md:mr-5" onClick={handleThemeSwitch}>
